...
I knew I wanted to be the best one.

.. _repetition-but-never-the-same:
...
current/undergraduate-and-graduate-catalog/course-descriptions/
css-computer-science-info-systems/200/css-225>`_
(mostly) and
`CSS 401 Systems for Cloud Computing <https://nl.smartcatalogiq.com/en/current/
...
.. note::
    ...
    I was involved in other courses too. But these two courses in specific
    stood out the most.

The content (more of less) stayed the same. I mean, how often do you expect a
...
their age and/or in their situations. This is when I realised that I'm learning
a lot about myself too.

.. _learning-beyond-the-syllabus:
...
The learning and teaching happened in both directions. Every time I learned
...
Again, looking back, I'm seeing my lectures and classrooms in a much different
...
to share, but for now I'll end my yearly rewind here.
